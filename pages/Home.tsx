        ...
        <section className="py-32 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10">
            <div className="text-center mb-16">
              <span className="text-amber-400 text-[10px] font-bold uppercase tracking-[0.5em] mb-4 block">
                PRÓXIMA EXPOSICIÓN
              </span>
              <h2 className="text-5xl md:text-6xl serif italic text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6 text-white">
                ...
                <p className="text-zinc-400 text-lg leading-relaxed italic font-light">
                  {featuredEvent.description}
                </p>

                <button
                  onClick={() => onNavigate('/eventos')}
                  className="px-12 py-5 bg-amber-400 text-zinc-900 tracking-[0.3em] uppercase text-[10px] font-bold hover:bg-amber-300 transition-all shadow-xl"
                >
